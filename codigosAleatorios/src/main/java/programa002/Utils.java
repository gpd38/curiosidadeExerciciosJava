...
public class Utils {
	...
	/**
	 * Metodo que gera um n�mero aleatorio com a quantidade de caracteres informada
	 * no par�metro
	 * 
	...
	/**
	 * Metodo que gera um cpf aleat�rio
	 * 
	 * @return
	 */
	...
	/**
	 * Metodo que gera um CNPJ aleat�rio
	 * 
	 * @return
	 */
	...
	/**
	 * Metodo que gera uma string com uma quantidade de caracteres aleat�rio
	 * 
	 * @return
	 */
	...
	/**
	 * Metodo que retorna uma data futura simulando uma previs�o de tempo para
	...
	/**
	 * Metodo que valida se o numeroAleatorio gerado, j� foi utilizado pelo sistema.
	 * 
	 * @param numAleatorio
	 * @return
	 */
